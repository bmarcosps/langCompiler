...
public interface LangParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code typeData}
	 * labeled alternative in {@link LangParser#btype}.
	 * @param ctx the parse tree
	 */
	void enterTypeData(LangParser.TypeDataContext ctx);
	/**
	 * Exit a parse tree produced by the {@code typeData}
	 * labeled alternative in {@link LangParser#btype}.
	 * @param ctx the parse tree
	 */
	void exitTypeData(LangParser.TypeDataContext ctx);
	/**
